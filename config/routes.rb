TranslationCenter::Engine.routes.draw do
  ...
  match "/set_language_from" => 'center#set_language_from', as: :set_lang_from, via: [:get, :post]
  match "/set_language_to" => 'center#set_language_to', as: :set_lang_to, via: [:get, :post]
end
